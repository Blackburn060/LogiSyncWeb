...
const HomePageInterno: React.FC = () => {
  ...
  const fetchNews = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://newsapi.org/v2/everything', {
        params: {
          apiKey: NewsApiKey,
          q: 'logistics OR transport OR supply chain OR shipping OR warehouse OR freight',
          language: 'pt',
          pageSize: 6,
          sortBy: 'relevancy',
        },
      ...
      // Filtra as notícias para remover qualquer uma cujo título contenha "[Removed]"
      ...
      saveToCache('news', filteredArticles);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <Navbar />
      <div className="flex-grow flex flex-col items-center p-12">
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md md:col-span-1">
              <h2 className="text-xl font-bold mb-2">Principais Notícias</h2>
              {loadingNews ? (
